...
<ul class="cd-accordion-menu animated">
    ...
    <li class="has-children">
        ...
        <ul>
            <li class="has-children">
                ...
                <ul>
                    <li><a href="/htm/food/hoteFoodlClass.action"  target="main"  style="font-size: 12px;">菜品类别</a></li>
                    <li><a href="/htm/food/hoteFoodlSubject.action"  target="main"  style="font-size: 12px;">菜品科目</a></li>
                    <li><a href="/htm/food/hotelFoodManage.action"  target="main"  style="font-size: 12px;">菜品详情</a></li>
                </ul>
            </li>
    ...
    <li class="has-children">
        ...
        <label for="group-5"  style="font-size: 13px;">酒店对账管理</label>
        <ul>
            <li><a href="/htm/base/updatePwd.action"  target="main"  style="font-size: 12px;">用户信息对账</a></li>
            <li><a href="/admin/adminUser/logout.action"  target="main"  style="font-size: 12px;">用户日终对账</a></li>
        </ul>
    </li>
